...
//Function evaluates user input for positive integers only
...
//Initial user prompt for item and quantity
		...
		.then(function(input) {
			...
			connection.query(queryStr, { item_id: item }, function(err, data) {
				...
				if (data.length === 0) {
					...
					//Conditionals when item is available
...
//Output current database info to terminal
